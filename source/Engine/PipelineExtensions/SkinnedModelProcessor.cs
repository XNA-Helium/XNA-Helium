...
namespace SkinnedModelPipeline
{
    ...
    public class SkinnedModelProcessor : ModelProcessor
    {
        ...
        /// <summary>
        /// Workaround a bug in the CTP (MIX10) release of the Windows Phone Emulator.
        /// The emulator does not yet support VertexElementFormat.Byte4, which is the default
        /// format for blend indices, so we convert this data to Vector4 format instead.
        /// </summary>
